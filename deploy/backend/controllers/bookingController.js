...
export const updateBookingStatus = async (req, res) => {
  try {
    ...
    // TODO: Send email/SMS notification to user about status change
    console.log(`Booking ${id} status updated to: ${status || 'unchanged'}`);
    console.log(`Payment status: ${paymentStatus || 'unchanged'}`);

    res
      .status(200)
      .json({ success: true, message: "Booking updated successfully", order });
  } catch (error) {
