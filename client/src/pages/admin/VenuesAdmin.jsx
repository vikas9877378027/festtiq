...
const PRODUCT_LIST_URL = `${API_BASE}/product/list`;
const PRODUCT_STOCK_URL = `${API_BASE}/product/stock`;
const PRODUCT_UPDATE_URL = `${API_BASE}/product/update`;
const PRODUCT_DELETE_URL = `${API_BASE}/product/delete`;
...
const VenuesAdmin = () => {
  ...
  const checkAuth = async () => {
    try {
      const response = await axios.get("http://localhost:4000/api/seller/is-auth", {
        withCredentials: true,
      });
